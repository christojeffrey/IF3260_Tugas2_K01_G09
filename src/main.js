...
// gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(vertices), gl.STATIC_DRAW);
let vertex_buffer = initVerticesBuffer(gl);

// Create and store data into color buffer
// var color_buffer = gl.createBuffer();
// gl.bindBuffer(gl.ARRAY_BUFFER, color_buffer);
// gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(colors), gl.STATIC_DRAW);
let color_buffer = initColorBuffer(gl);

// Create and store data into index buffer
// var index_buffer = gl.createBuffer();
// gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, index_buffer);
// gl.bufferData(gl.ELEMENT_ARRAY_BUFFER, new Uint16Array(indices), gl.STATIC_DRAW);
let index_buffer = initIndicesBuffer(gl);
/*=================== SHADERS =================== */
...
let vertShader = loadShader(gl, gl.VERTEX_SHADER, vertCode);

// var fragShader = gl.createShader(gl.FRAGMENT_SHADER);
// gl.shaderSource(fragShader, fragCode);
// gl.compileShader(fragShader);
let fragShader = loadShader(gl, gl.FRAGMENT_SHADER, fragCode);
